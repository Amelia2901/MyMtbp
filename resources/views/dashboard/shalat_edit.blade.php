            ...
            <div class="card-body">
              ...
              <form action="{{ route('shalat.update', $shalat->id) }}" method="POST" id="shalat_form">
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="shalat_name" id="shalat_name" value="{{ old('shalat_name', $shalat->shalat_name) }}" required>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="time" class="form-control" name="shalat_time" id="shalat_time" value="{{ old('shalat_time', $shalat->shalat_time) }}" required>
                    </div>
                </div>
