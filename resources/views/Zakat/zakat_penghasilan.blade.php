...
<head>
    ...
    <title>Zakat | Zakat Penghasilan</title>
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Zakat Penghasilan</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Formulir Zakat Penghasilan</h5>
                            <form action="{{ route('ZakatPenghasilan.storeOrUpdate') }}" method="POST"
                                enctype="multipart/form-data" id="zakat_penghasilans">
                                @csrf
                                <!-- input type hidden -->
