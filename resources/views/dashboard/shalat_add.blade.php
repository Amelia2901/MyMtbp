        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('shalat.store') }}" method="POST" id="shalat_form">
                @csrf  <!-- CSRF token for security -->
                @if (isset($prayer_schedule))
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" name="shalat_name" id="shalat_name" value="" required>
                    </div>
                </div>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-sm-10">
                        <input type="time" class="form-control" name="shalat_time" id="shalat_time" value="" required>
                    </div>
                </div>
