...
<body>
    ...
    <script>
        function resetValidation() {
            $('#description_1').removeClass('is-invalid');
            $('#description_1').next('.invalid-feedback').remove();
        }
        ...
        function simpan() {
            ...
            if ($.trim($("#description_1").val()) == "") {
                $('#description_1').addClass('is-invalid');
                $('#description_1').after('<div class="invalid-feedback">Deskripsi wajib diisi.</div>');
                valid = false;
            }
        ...
        $('#description_1').on('input', function() {
            if ($.trim($(this).val()) !== "") {
