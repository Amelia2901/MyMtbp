        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <form action="{{ route('banner.store') }}" method="POST" enctype="multipart/form-data" id="banner_dashboard_form">
                @csrf   
                <div class="row mb-3">
                  <label for="inputText" class="col-sm-2 col-form-label">Foto Banner</label>
                  <div class="col-sm-10">
                    <input class="form-control" type="file" id="banner_photo" name="banner_photo">
                  </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" name="banner_description" id="banner_description">
                  </div>
                </div>
                <div class="row mb-3">
                  <div class="col-sm-12">
