...
<head>
    ...
    <title>Masjid Taman Bumi Prima</title>
...
<body>
    ...
    <footer id="footer" class="footer">
        <div class="copyright">
            &copy; Copyright <strong><span>Mesjid Taman Bumi Prima</span></strong>. 2025
        </div>
        <div class="credits">
            ...
            Designed by <a href="https://itfpsolutions.com/public/">Footprint Solutions</a>
        </div>
    </footer><!-- End Footer -->
